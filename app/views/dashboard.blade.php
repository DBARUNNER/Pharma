...
<!-- Mirrored from lab2023.github.io/hierapolis/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2016 13:26:03 GMT -->
...
<head>
    ...
    <link href="{{ URL::asset('assets/stylesheets/application-a07755f5.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('assets/font-awsome/font-awesome.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('assets/images/favicon.ico') }}" rel="icon" type="image/ico" />
  ...
  <body class='main page'>
    ...
    <!-- Footer -->
    <!-- Javascripts -->
    <script src="{{ URL::asset('assets/jQuery/jquery/1.10.1/jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ URL::asset('assets/jQuery/jquery-ui.min.js ') }}" type="text/javascript"></script>
    <script src="{{ URL::asset('assets/jQuery/modernizr/2.6.2/modernizr.min.js') }}" type="text/javascript"></script>
    <script src="{{ URL::asset('assets/javascripts/application-985b892b.js') }}" type="text/javascript"></script>
    <!-- Google Analytics -->
    <script>
...
<!-- Mirrored from lab2023.github.io/hierapolis/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2016 13:26:04 GMT -->
</html>
